...
public class RepititionSchedule {
    ...
    public RepititionSchedule from(com.firepitmedia.earnit.model.RepititionSchedule schedule){
        if  (schedule != null) {
            ...
            for (com.firepitmedia.earnit.model.DayTaskStatus status : schedule.getDayTaskStatuses()) {
