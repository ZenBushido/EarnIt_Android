...
import com.firepitmedia.earnit.BuildConfig;
...
public final class AppConstant {
    ...
    public static String[] CURRENTBALANCEARRY ={
            "255",
            "28",
            "125",
            "320",
...
//    public final static String BASE_URL_PROD = "https://api.myearnitapp.com:8443/earnit-api";
    ...
    public final static String TASKS_API_DELETE = "/tasks/";
    public final static String GOAL_DELETE = "/goals/";
    ...
    public final static String PASSWORD_REMINDER = "/passwordReminder";
    ...
    public final static String CHILD_REQ_TASK_APPROVAL = "child_req_task_approval";
    public final static String SCREENRULE = "screenrule";
    ...
    public final static String PARENT_CALENDAR_SCREEN = "parent_calendar_screen";
   ...
   // public static final String BUCKET_NAME = BuildConfig.DEBUG ? BUCKET_NAME_QA : BUCKET_NAME_PROD;
     public static final String BUCKET_NAME = "earnitapp-dev" ;
