...
public class GoalActivity extends BaseActivity implements View.OnClickListener, Validator.ValidationListener, NavigationDrawer.OnDrawerToggeled {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        try {
            Picasso.with(goalActivity).load("https://s3-us-west-2.amazonaws.com/earnitapp-dev/new/" + childObject.getAvatar()).error(R.drawable.default_avatar).into(childAvatar);
        } catch (Exception e) {
